...
create table if not exists profiles (
  ...
  clics_chile int not null default 0,
  clics_liberados int not null default 0,
  saldo_disponible numeric(12,0) not null default 0,
  saldo_transferido numeric(12,0) not null default 0,
